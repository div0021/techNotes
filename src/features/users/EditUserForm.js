...
const EditUserForm = ({user}) => {
 ...
 const [active,setActive] = useState(user.active); // use to stop the access of user by admin.
      ...
      <form className='form' onSubmit={e => e.preventDefault()}>
         ...
         <div className='form__title-row'>
            ...
            <div className='form__action-buttons'>
               ...
               <button
                className = "icon-button" title="Delete" onClick={onDeleteUserClicked} >
         ...
         <input 
             ...
             <input className={`form__input ${validPwdClass}`} id='password'
